...
(function (root, factory) {
  ...
  */
  ...
  function _setHelperLayerPosition(helperLayer) {
    if (helperLayer) {
      ...
      if (_isFixed(currentElement.element)) {
        jQuery(helperLayer).addClass( 'introjs-fixedTooltip' );
      } else {
        jQuery(helperLayer).removeClass( 'introjs-fixedTooltip' );
      }
  ...
  function _getOffset(element) {
    ...
    // check <html> element for top margin
    var html_outer = parseInt( jQuery('html').css('margin-top'), 10 );
    if ( html_outer > 0 ) {
      _y += html_outer;
    }
